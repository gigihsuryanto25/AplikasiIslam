...
public class ClientAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    private OnPostExecuteListener mPostExecuteListener = null; private Context mContext;

    private String base_api_url = "https://api.banghasan.com/sholat/format/json/"; public String api = "";
    ...
    { this.mPostExecuteListener = mPostExecuteListener;
       this.mContext = mContext; this.api = api_url;
    }
    @Override
